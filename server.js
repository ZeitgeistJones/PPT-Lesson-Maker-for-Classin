...
// JSON schema Gemini is constrained to — with responseSchema set, Gemini's
// output is guaranteed to match this shape, so no markdown-fence-stripping
// or "please respond with only JSON" prompt-begging is needed.
const LESSON_SCHEMA = {
  type: 'object',
  properties: {
    title: { type: 'string' },
...
// Builds the prompt and calls the Gemini generateContent API.
